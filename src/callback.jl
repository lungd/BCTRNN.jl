...
function (mcb::MyCallback)(p,l,ŷ,y; kwargs...)
  ...
  mcb.iter % mcb.nsamples == 0 && invoke_epoch_cb!(mcb, p, l, ŷ, y; kwargs...)
  return cbout
end
...
function invoke_sample_cb!(mcb::MyCallback, p,l,ŷ,y; kwargs...)
  cbout = mcb.cb(p,l,ŷ,y;doplot=false,kwargs...)
  push!(mcb.losses, l)
  mcb.iter += 1
  return cbout
end

function invoke_epoch_cb!(mcb::MyCallback, p, l, ŷ, y, kwargs...)
  mcb.epoch += 1
  mcb.ecb(mcb)
  mcb.cb(p,l,ŷ,y;doplot=true,kwargs...)
  reset!(mcb)
end
